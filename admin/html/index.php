...
<body class="image">
  ...
  <div id="id01" class="modal">
    ...
    <form class="modal-content animate" action="../../user/html/Login.php" method="post">
      <div class="imgcontainer">
        <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
        <img src="../../user/User-Profile-PNG-High-Quality-Image.png" alt="Avatar" class="avatar">
      </div>
  ...
  <div id="id03" class="modal">
    ...
    <form class="modal-content animate" action="../../user/html/signUp.php" method="post">
      <div class="imgcontainer">
